...
public class DialogUtil {
    public static Alert buildSimpleDialog(String title, String header, String body, Alert.AlertType type) {
    ...
    public static Alert buildWarningDialog(String title, String header, String body) {
    ...
    public static Alert buildExceptionDialog(String title, String header, Exception e) {
        ...
        alert.setTitle(title);
        alert.setHeaderText(header);
        Label label = new Label("Exception stack: ");
